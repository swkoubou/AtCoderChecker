...
$(function () {
    ...
    ns.AlertViewModel = function AlertViewModel(o) {
         ...
         * 有効なアラートコンテンツ
         *
         * @type {Array.<swkoubou.atcoderchecker.viewmodel.AlertContent>}
         */
         ...
         * アラートコンテンツを追加する
         *
         * @param {swkoubou.atcoderchecker.viewmodel.AlertContent} content
         * @returns {swkoubou.atcoderchecker.viewmodel.AlertViewModel}
         */
